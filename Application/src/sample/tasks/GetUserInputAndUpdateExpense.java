...
public class GetUserInputAndUpdateExpense extends Task<Void> {
    ...
    public GetUserInputAndUpdateExpense(int id, JFXTextField nameField, JFXTextField categoryField,
    ...
    /**
     * Gets connection from database and updates a specific row in expenses table
     */
    @Override
    protected Void call() {
        try {
            ...
            final String call = "{call UPDATE_EXP(?,?,?,?,?,?,?,?,?)}";
            ...
            // log about success
            PushUpLogging.logSuccess("Data row in expenses table updated successfully", "Database Update Successful!");
