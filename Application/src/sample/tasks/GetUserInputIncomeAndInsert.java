...
public class GetUserInputIncomeAndInsert extends Task<Void> {
    ...
    public GetUserInputIncomeAndInsert(JFXTextField nameField, JFXTextField categoryField,
    ...
    protected Void call() {
        try {
            ...
            // log about success
            PushUpLogging.logSuccess("Data row inserted into income table successfully", "Database Insertion Successful!");
