...
public class GetUserInputIncomeAndPerformQuery extends Task<Void> {
    ...
    public GetUserInputIncomeAndPerformQuery(JFXTextField nameField, JFXTextField categoryField,
